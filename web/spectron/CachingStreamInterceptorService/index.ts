...
SpectronMain2.create({ windowFactory: defaultWindowFactory }).run(
    async state => {
        //
        ...
        const service = new CachingStreamInterceptorService(
            cacheRegistry,
            sess.protocol
        );
        ...
        const didFinishLoadPromise = WebContentsPromises.once(
