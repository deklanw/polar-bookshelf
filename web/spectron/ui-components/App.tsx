...
import {
    ListOptionType,
    ListSelector,
} from '../../js/ui/list_selector/ListSelector';
...
class App<P> extends React.Component<{}, IAppState> {
    ...
    public render() {
        ...
        const docMeta = Proxies.create(
            MockDocMetas.createWithinInitialPagemarks('0x001', 4)
        );
        ...
        const textSelections: TextRect[] = [
            new TextRect({ text: 'hello world' }),
        ];
        ...
        docMeta.pageMetas[1].textHighlights[textHighlight.id] =
            textHighlight.value;
        ...
        const existingTags: Tag[] = [{ id: 'google', label: 'google' }];
            ...
            <div>
                ...
                <UncontrolledDropdown direction="down" size="sm">
                    ...
                    <DropdownMenu>
                        <DropdownItem size="sm" onClick={() => console.log('')}>
                            <i className="fas fa-hdd" /> from disk
                        </DropdownItem>
                        <DropdownItem size="sm" onClick={() => console.log('')}>
                ...
                <FlashcardInputForCloze
                    ...
                    onFlashcardCreated={(flashcardType, fields) =>
                        console.log('created: ', flashcardType, fields)
                    }
                ...
                <p>List of important UI components in Polar.</p>
                ...
                <DocRepoTableDropdown
                    id="table-dropdown"
                    onSelectedColumns={newOptions =>
                        console.log('onSelectedColumns: ', newOptions)
                    }
                />
