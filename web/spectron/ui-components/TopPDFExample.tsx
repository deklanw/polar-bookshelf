                ...
                {entries.map(entry => (
                    <div key={idx++} style={Styles.entry}>
                        ...
                        <div style={Styles.link}>
                            <a href={entry.link} download={entry.download}>
                                {entry.title}
                            </a>
                        </div>
                    </div>
...
const entries: Entry[] = [
    ...
    {
        title:
            'Testimony of Mark Zuckerberg \u2013 Hearing Before US House of Representatives [pdf]',
        score: 280,
        link:
    ...
    {
        title:
            'The Evolution of C Programming Practices: A Study of Unix (2016) [pdf]',
        score: 203,
        link:
    ...
    {
        title:
            'Introduction to OS Abstractions Using Plan 9 from Bell Labs (2007) [pdf]',
        score: 191,
    ...
    {
        title:
            'MtGox: Announcement of Commencement of Civil Rehabilitation Proceedings [pdf]',
        score: 167,
    ...
    {
        title:
            'Math from Three to Seven: The Story of a Mathematical Circle for Preschoolers [pdf]',
        score: 161,
    ...
    {
        title:
            'DeepLog: Anomaly Detection and Diagnosis from System Logs (2017) [pdf]',
        score: 149,
    ...
    {
        title:
            'Advanced Data Analysis from an Elementary Point of View (2017) [pdf]',
        score: 139,
    ...
    {
        title:
            'What do Stanford CS PhD students think of their PhD program? [pdf]',
        score: 130,
        link:
    ...
    {
        title:
            'Low-Latency Video Processing Using Thousands of Tiny Threads [pdf]',
        score: 130,
        link:
    ...
    {
        title:
            'Mindfulness Meditation Impairs Task Motivation but Not Performance [pdf]',
        score: 120,
        link:
    ...
    {
        title:
            'Motorola M68000 Family Programmer\u2019s Reference Manual (1992) [pdf]',
        score: 110,
    ...
    {
        title:
            'Oberon System Implemented on a Low-Cost FPGA Board (2015) [pdf]',
        score: 109,
        link:
    ...
    {
        title:
            'The Haskell School of Music \u2013 From Signals to Symphonies (2014) [pdf]',
        score: 105,
    ...
    {
        title:
            'Sketchpad: A man-machine graphical communication system (1963) [pdf]',
        score: 104,
    ...
    {
        title:
            'Mindstorms: Children, Computers, and Powerful Ideas (1980) [pdf]',
        score: 103,
        link:
    ...
    {
        title:
            'How to do with probabilities what people say you can\u2019t (1985) [pdf]',
        score: 97,
    ...
    {
        title:
            'Police Use of Force: An Examination of Modern Policing Practices [pdf]',
        score: 97,
    ...
    {
        title:
            'A micro manual for Lisp \u2013 Not the whole truth (1978) [pdf]',
        score: 95,
    ...
    {
        title:
            'MeltdownPrime, SpectrePrime: Exploiting Invalidation-Based Coherence Protocols',
        score: 90,
    ...
    {
        title:
            'TensorFlow: Machine Learning on Heterogeneous Distributed Systems (2015) [pdf]',
        score: 85,
        link:
    ...
    {
        title:
            'Loss of Locational Privacy While Traveling in Your Automobile (2013) [pdf]',
        score: 81,
        link:
    ...
    {
        title:
            'A Formal Security Analysis of the Signal Messaging Protocol (2017) [pdf]',
        score: 81,
    ...
    },
    {
        ...
        score: 76,
        link:
            'https://groups.csail.mit.edu/mac/users/gjs/6.945/readings/robust-systems.pdf',
    ...
    {
        title:
            'Comprehensive and biased comparison of OpenBSD and FreeBSD (2017) [pdf]',
        score: 75,
        link:
    ...
    {
        title:
            'Design and Evaluation of FPGA-Based Gigabit Ethernet Network Card (2004) [pdf]',
        score: 73,
        link:
    ...
    {
        title:
            'An Empirical Study of Programmers\u2019 Acquisition of New Programming Languages [pdf]',
        score: 73,
        link:
    ...
    {
        title:
            'Alchemy: A Language and Compiler for Homomorphic Encryption Made Easy [pdf]',
        score: 71,
    ...
    {
        title:
            'Sinking of the US Cargo Vessel El Faro: Illustrated digest [pdf]',
        score: 68,
        link:
    ...
    {
        title:
            'High Performance Computing: Are We Just Getting Wrong Answers Faster? (1998) [pdf]',
        score: 67,
    ...
    {
        title:
            "Notes on Landauer's principle, reversible computation, Maxwell's Demon (2003) [pdf]",
        score: 67,
        link:
    ...
    {
        title:
            'Defeating Modern Secure Boot Using Second-Order Pulsed EM Fault Injection [pdf]',
        score: 64,
        link:
    ...
    {
        title:
            'Monoid machines: a O(log n) parser for regular languages (2006) [pdf]',
        score: 64,
    ...
    {
        title:
            'Adopting Lessons from Offline Ray-Tracing to Real-Time Ray-Tracing [pdf]',
        score: 63,
        link:
    ...
    {
        title:
            'The Structure of \u201cUnstructured\u201d Decision Processes (1976) [pdf]',
        score: 63,
        link:
    ...
    {
        title:
            'Modeling Potential Income and Welfare \u2013 Benefits in Illinois (2014) [pdf]',
        score: 62,
        link:
    ...
    {
        title:
            'Setting, Elaborating, Reflecting on Goals Improves Academic Performance (2010) [pdf]',
        score: 61,
        link:
    ...
    {
        title:
            'On the Detection of Kernel-Level Rootkits Using Hardware Performance Counters [pdf]',
        score: 61,
    ...
    {
        title:
            'A Stall-Free Real-Time Garbage Collector for Reconfigurable Hardware (2012) [pdf]',
        score: 60,
        link:
    ...
    {
        title:
            'Ambit: In-Memory Accelerator for Bulk Bitwise Operations Using Commodity DRAM [pdf]',
        score: 56,
        link:
    ...
    {
        title:
            'Understanding, finding, and eliminating ground loops (2003) [pdf]',
        score: 54,
    ...
    {
        title:
            'American Gut: An Open Platform for Citizen Science Microbiome Research [pdf]',
        score: 52,
    ...
    {
        title:
            'How the Reformulation of OxyContin Ignited the Heroin Epidemic [pdf]',
        score: 52,
    ...
    {
        title:
            'The Intel 80x86 Process Architecture: Pitfalls for Secure Systems (1995) [pdf]',
        score: 49,
        link:
    ...
    {
        title:
            'Mathematics in the 20th century \u2013 Sir Michael Atiyah [pdf]',
        score: 47,
    ...
    },
    {
        ...
        score: 44,
        link:
            'http://archive.computerhistory.org/resources/access/text/2013/05/102657970-05-01-acc.pdf',
    ...
    {
        title:
            'Relationship Between Practice and Performance in Sports: A Meta-Analysis (2016) [pdf]',
        score: 43,
        link:
    ...
    {
        title:
            'Quantitative analysis of family trees with millions of relatives (2017) [pdf]',
        score: 42,
        link:
    ...
    {
        title:
            'Scalable 10 Gbps TCP/IP Stack Architecture for Reconfigurable Hardware (2015) [pdf]',
        score: 39,
    ...
    {
        title:
            'Understand and Eliminate JVM Warm-Up Overhead in Data-Parallel Systems (2016) [pdf]',
        score: 39,
        link:
    ...
    {
        title:
            'Compiling a Subset of APL into a Typed Intermediate Language (2014) [pdf]',
        score: 39,
    ...
    {
        title:
            'Genetic Predisposition to Obesity and Medicare Expenditures [pdf]',
        score: 39,
    ...
    {
        title:
            'Insider Accounts of Computing and Life at BBN: A sixty-year report (2011) [pdf]',
        score: 37,
    ...
    {
        title:
            'Why Johnny Doesn\u2019t Use Two Factor \u2013 A Study of the FIDO U2F Security Key [pdf]',
        score: 37,
    ...
    {
        title:
            'House of Commons committee re-invites to Mark Zuckerburg to appear [pdf]',
        score: 36,
        link:
    ...
    },
    {
        ...
        score: 36,
        link:
            'https://www.usenix.org/system/files/conference/atc18/atc18-amit.pdf',
    ...
    {
        title:
            'How News Aggregators Help Development Communities Shape and Share Knowledge [pdf]',
        score: 34,
    ...
    },
    {
        ...
        score: 34,
        link:
            'http://grail.cs.washington.edu/wp-content/uploads/2017/10/luo2017pca.pdf',
    ...
    },
    {
        ...
        score: 34,
        link:
            'https://www.usenix.org/system/files/conference/nsdi17/nsdi17-kablan.pdf',
    ...
    {
        title:
            'Timing Analysis of Keystrokes and Timing Attacks on SSH (2001) [pdf]',
        score: 33,
    ...
    {
        title:
            'Voice-matching technology was developed by MIT/Lincoln Labs under NSA contract [pdf]',
        score: 32,
        link:
    ...
    {
        title:
            'Cognitive Networks: Brains, Internet, and Civilizations (2017) [pdf]',
        score: 31,
        link:
    ...
    {
        title:
            'Revisiting the Risks of Bitcoin Currency Exchange Closure [pdf]',
        score: 31,
    ...
    {
        title:
            'Field Guide for Designing Human Interaction with Intelligent Systems (1998) [pdf]',
        score: 30,
        link:
    ...
    {
        title:
            'Cicada: Dependably Fast Multi-Core In-Memory Transactions (2017) [pdf]',
        score: 29,
    ...
    },
    {
        ...
        score: 28,
        link:
            'http://www.eecg.toronto.edu/~ganesa10/assets/pdfs/whatsnext-hpca2019.pdf',
    ...
    {
        title:
            'Phoneme- and Word-Based Learning of English Words Presented to the Skin',
        score: 26,
        link:
    ...
    {
        title:
            'The eXpress Data Path: Fast Programmable Packet Processing in the OS Kernel [pdf]',
        score: 26,
        link:
    ...
    {
        title:
            'Internet Architecture Board on the Australian Assistance and Access Bill [pdf]',
        score: 26,
        link:
    ...
    {
        title:
            'Knut Wicksell: the Birth of Modern Monetary Policy (2004) [pdf]',
        score: 26,
        link:
            'https://www.dallasfed.org/~/media/documents/research/ei/ei0401.pdf',
    ...
    },
    {
        ...
        score: 25,
        link:
            'https://static1.squarespace.com/static/5581f17ee4b01f59c2b1513a/t/59ea16f7e5dd5b23063a3154/1508513533577/Artemis_Volatility+and+the+Alchemy+of+Risk_2017.pdf',
        commentsLink: 'https://news.ycombinator.com/item?id=16409601',
    },
    {
        title:
            'Leakage-Resilient Client-Side Deduplication of Encrypted Data in Cloud Storage [pdf]',
        score: 25,
    ...
    },
    {
        ...
        score: 25,
        link:
            'https://www.emsec.rub.de/media/crypto/veroeffentlichungen/2018/04/16/PDN_Masking.pdf',
    ...
    {
        title:
            'The SIGABA/ECM II Cipher Machine: \u201cA Beautiful Idea\u201d (2015) [pdf]',
        score: 23,
        link:
    ...
    },
    {
        ...
        score: 22,
        link:
            'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1737287/pdf/v070p00524.pdf',
    ...
    {
        title:
            'Doppelg\u00e4nger Finder: Taking Stylometry to the Underground (2014) [pdf]',
        score: 22,
        link:
            'https://www1.icsi.berkeley.edu/~sadia/papers/oakland2014-underground.pdf',
    ...
    {
        title:
            "The Effect of Zoning on Housing Prices \u2013 Research from Australia's Reserve Bank [pdf]",
        score: 21,
    ...
    },
    {
        ...
        score: 21,
        link:
            'http://users-cs.au.dk/mic/publications/journal/25--bulletin2007.pdf',
        commentsLink: 'https://news.ycombinator.com/item?id=18186847',
    },
    {
        title:
            'A Scalable, Commodity Data Center Network Architecture (2008) [pdf]',
        score: 21,
    ...
    },
    {
        ...
        score: 20,
        link:
            'http://blog.thegrandlocus.com/static/misc/is_the_scientific_paper_fraudulent.pdf',
    ...
    {
        title:
            'Discerning the Out-Of-Order Advantage: Is It Speculation or Dynamism? (2013) [pdf]',
        score: 20,
    ...
    {
        title:
            'Lunar Laser Ranging: a continuing legacy of the Apollo program (1994) [pdf]',
        score: 19,
    ...
    {
        title:
            'Construction of the Transreal Numbers and Algebraic Transfields [pdf]',
        score: 18,
    ...
    {
        title:
            'Crypko White Paper: Cryptocollectible Game Empowered by GANs [pdf]',
        score: 18,
    ...
    {
        title:
            'Scrapino \u2013 Self-sustainable robot from e-scrap using renewable energy [pdf]',
        score: 17,
        link:
    ...
    {
        title:
            'A Survey of Rollback-Recovery Protocols in Message-Passing Systems (2002) [pdf]',
        score: 15,
    ...
    {
        title:
            'Examining Children\u2019s Online Privacy Protection Act compliance [pdf]',
        score: 15,
        link:
    ...
    },
    {
        ...
        score: 15,
        link:
            'http://fivedots.coe.psu.ac.th/Software.coe/242-535_ADA/Background/Readings/knuth_song_complexity.pdf',
    ...
    {
        title:
            'Revisiting a Summer Vacation: Digital Restoration and Typesetter Forensics [pdf]',
        score: 14,
    ...
    {
        title:
            'Evolution of Multicellular Computing: Parallels with Multicellular Life (2009) [pdf]',
        score: 13,
    ...
    {
        title:
            'The Cult of the Bound Variable: ICFP Programming Contest (2006) [pdf]',
        score: 12,
    ...
    {
        title:
            'Technical Specification for the Delivery of Television Programs to the BBC [pdf]',
        score: 12,
        link:
    ...
    {
        title:
            'Falcon Heavy Demonstration Mission (overview and timeline) [pdf]',
        score: 12,
        link:
    ...
    },
    {
        ...
        score: 12,
        link:
            'http://dominic-mulligan.co.uk/wp-content/uploads/2011/08/oopsla-elf-linking-2016.pdf',
        commentsLink: 'https://news.ycombinator.com/item?id=18713230',
    },
    {
        title:
            'Response time in man-computer conversational transactions (1968) [pdf]',
        score: 12,
        link:
    ...
    {
        title:
            'TxFS: Leveraging File-System Crash Consistency to Provide Transactions [pdf]',
        score: 12,
    ...
    {
        title:
            'The Most Influential Paper Gerard Salton Never Wrote (2004) [pdf]',
        score: 11,
        link:
            'https://www.ideals.illinois.edu/bitstream/handle/2142/1697/Dubin748764.pdf',
    ...
    {
        title:
            '*ANY* Android manufacturer monitors users without consent [pdf]',
        score: 11,
    ...
    {
        title:
            "Alfred Stieglitz's Lantern Slides: History, Technique and Analysis (2015) [pdf]",
        score: 10,
        link:
            'https://www.researchgate.net/profile/Rosina_Herrera_Garrido/publication/266251396_Alfred_Stieglitz%27s_Lantern_Slides_History_Technique_and_Technical_Analysis/links/54f81f290cf2ccffe9dcd349/Alfred-Stieglitzs-Lantern-Slides-History-Technique-and-Technical-Analysis.pdf',
    ...
    {
        title:
            'Design and Evaluation of a Continuous Consistency Model for Replicated Services [pdf]',
        score: 10,
        link:
    ...
    },
    {
        ...
        score: 10,
        link:
            'https://pure.royalholloway.ac.uk/portal/files/31169565/paper.pdf',
        commentsLink: 'https://news.ycombinator.com/item?id=18399899',
    },
    {
        title:
            'Representing Control in the Presence of One-Shot Continuations (1996) [pdf]',
        score: 10,
    ...
    },
    {
        ...
        score: 9,
        link:
            'http://www.milliman.com/uploadedFiles/insight/2018/status-collectively-bargained-benefits.pdf',
    ...
    {
        title:
            'Politics in the Facebook Era: Evidence from the 2016 US Presidential Elections [pdf]',
        score: 9,
        link:
    ...
    {
        title:
            'Mata Hari with a Clockwork Eye, Alligators in the Sewer (1963) [pdf]',
        score: 9,
    ...
    {
        title:
            'Counter Culture: Towards a History of Greek Numeracy (2002) [pdf]',
        score: 8,
        link:
            'http://worrydream.com/refs/Netz%20-%20Counter%20Culture%20-%20Towards%20a%20History%20of%20Greek%20Numeracy.pdf',
    ...
    {
        title:
            'Physicians give patients an average of 11 seconds before cutting them off [pdf]',
        score: 7,
        link:
    ...
    },
    {
        ...
        score: 6,
        link:
            'https://blog.mozilla.org/wp-content/uploads/2018/06/2018-Mozilla-Awards-Application-Guide_-Creative-Media-Awards.pdf',
    ...
    },
    {
        ...
        score: 6,
        link:
            'https://www.ics.uci.edu/~redmiles/inf233-FQ07/oldpapers/SollowayEhrlich.pdf',
    ...
    {
        title:
            'It Takes $4.2M Net Worth to Be Considered Wealthy in Silicon Valley [pdf]',
        score: 5,
        link:
    ...
    },
    {
        ...
        score: 5,
        link:
            'http://delivery.acm.org/10.1145/3210000/3206019/p127-richter.pdf',
    ...
    {
        title:
            'Zener diodes have coupled quantum noise that travels at c [pdf]',
        score: 5,
    ...
    },
    {
        ...
        score: 5,
        link:
            'https://scholarspace.manoa.hawaii.edu/bitstream/10125/19211/1/AP-v22n1-41-60.pdf',
    ...
    },
    {
        ...
        score: 4,
        link:
            'https://my.vaisala.net/Vaisala%20Documents/Scientific%20papers/2016%20ILDC%20ILMC/Ron%20Holle.%20Number%20of%20Documented%20Global%20Lightning%20Fatalities.pdf',
        commentsLink: 'https://news.ycombinator.com/item?id=17195459',
    },
    {
        title:
            'Resistance to the Use of Anesthesia in the Mid-19th Century (2005) [pdf]',
        score: 4,
    ...
    {
        title:
            'The modality of mortality in domain names: an in-depth study of domain lifetimes [pdf]',
        score: 4,
        link:
    ...
    },
    {
        ...
        score: 4,
        link:
            'https://dasher.wustl.edu/chem430/reading/jstatphys-43-731-86.pdf',
    ...
    {
        title:
            'Fast Programmable Match-Action Processing in Hardware for SDN (2013) [pdf]',
        score: 4,
