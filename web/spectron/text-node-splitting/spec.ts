...
describe('Text Node Splitting', function() {
    ...
    xit('splitNode', async function() {
        ...
        const splitNodes = await this.app.client.execute(() => {
            const {
                TextNodeRows,
            } = require('../../js/highlights/text/selection/TextNodeRows');
    ...
    xit('computeTextRegions', async function() {
        ...
        // first check that we can split the basic nodes properly.
        const textRegions = await this.app.client.execute(() => {
            const {
                TextNodeRows,
                NodeArray,
            } = require('../../js/highlights/text/selection/TextNodeRows');
            ...
            const nodeArray = NodeArray.createFromElement(p);
    ...
    xit('computeTextBlocks', async function() {
        ...
        // first check that we can split the basic nodes properly.
        const textBlocks = await this.app.client.execute(() => {
            const {
                TextNodeRows,
                NodeArray,
            } = require('../../js/highlights/text/selection/TextNodeRows');
        ...
        const expected = [
            ...
            },
            {
                nrNodes: 57,
                text:
                    '7.purus mattis felis, eget consequat eros velit et erat. ',
            },
            {
                nrNodes: 12,
                text: '8.Curabitur ',
            ...
            },
            {
                nrNodes: 62,
                text:
                    'rhoncus, nibh leo ultricies urna, eget mollis mi\n    nisl nec ',
            },
            {
                nrNodes: 55,
            ...
            },
            {
                nrNodes: 65,
                text:
                    'pharetra orci tortor, eget gravida\n    felis dictum ac. Maecenas ',
            },
            {
                nrNodes: 62,
                text:
                    'convallis nunc ultrices massa bibendum, et\n    dignissim elit ',
            },
            {
                nrNodes: 59,
                text:
                    'tempus. Ut in luctus dolor, et maximus nisi. Etiam non\n    ',
            },
            {
                nrNodes: 57,
                text:
            ...
            },
            {
                nrNodes: 57,
                text:
                    'sodales. Vestibulum consectetur nulla\n    elementum eros ',
            },
            {
                nrNodes: 56,
                text:
                    'rhoncus, non interdum diam tristique. Praesent interdum ',
            },
            {
                nrNodes: 63,
                text:
            ...
            },
            {
                nrNodes: 63,
                text:
                    'Integer sed molestie\n    urna, a sodales libero. Morbi egestas ',
            },
            {
                nrNodes: 59,
                text:
                    'egestas tortor sed sagittis. Aenean et\n    tellus non quam ',
            },
            {
                nrNodes: 36,
