...
export class ComponentManager {
    ...
    public onDocumentLoaded(documentLoadedEvent: DocumentLoadedEvent) {
        ...
        docMetaModel.registerListener(
            documentLoadedEvent.docMeta,
            this.onComponentEvent.bind(this)
        );
    }

    public onComponentEvent(componentEvent: AnnotationEvent) {
        ...
        if (componentEvent.mutationState === MutationState.PRESENT) {
            ...
            const containerLifecycleListener = this.containerProvider.createContainerLifecycleListener(
                container
            );
            ...
            this.components[componentEvent.id] = new ComponentEntry(
...
export class ComponentEntry {
     ...
     */
    constructor(
        containerLifecycleListener: ContainerLifecycleListener,
        component: Component
    ) {
