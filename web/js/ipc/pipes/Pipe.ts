...
export abstract class Pipe<E, M>
    implements WritablePipe<M>, ReadablePipe<E, M> {
    public abstract write(channel: string, message: M): void;

    public abstract on(channel: string, listener: PipeListener<E, M>): void;

    public abstract once(channel: string, listener: PipeListener<E, M>): void;
...
export type PipeListener<E, M> = (notification: PipeNotification<E, M>) => void;
