...
export class DocAnnotationIndexes {
    public static delete(
        ...
        const docAnnotationMap = Object.assign(
            {},
            docAnnotationIndex.docAnnotationMap
        );
        ...
        const tmpIndex = new DocAnnotationIndex(
            docAnnotationMap,
    ...
    public static rebuild(
        ...
        function sortScore(item: DocAnnotation) {
            return (
                item.pageNum * 100000 + item.position.y * 100 + item.position.x
            );
        }
