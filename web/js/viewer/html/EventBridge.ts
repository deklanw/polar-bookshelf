...
export class EventBridge {
    ...
    public async start() {
        ...
        await DocumentReadyStates.waitFor(
    ...
    private mouseListener(event: any) {
        ...
        Object.defineProperty(newEvent, 'clientX', {
            value: eventPoints.client.x,
        });
        Object.defineProperty(newEvent, 'clientY', {
            value: eventPoints.client.y,
        });

        Object.defineProperty(newEvent, 'offsetX', {
            value: eventPoints.offset.x,
        });
        Object.defineProperty(newEvent, 'offsetY', {
            value: eventPoints.offset.y,
        });
