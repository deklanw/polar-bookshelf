...
describe('TextHighlightModel', function() {
    ...
    describe('Listen for new highlights', function() {
        ...
        it('New text highlights on new pages', function() {
            ...
            textHighlightModel.registerListener(docMeta, function(
                textHighlightEvent
            ) {
                mutations.push(summarize(textHighlightEvent));
            });
            ...
            docMeta.getPageMeta(3).textHighlights[textHighlightRecord.id] =
...
function createDocMeta() {
    ...
    docMeta.getPageMeta(1).textHighlights[textHighlightRecord.id] =
        textHighlightRecord.value;
