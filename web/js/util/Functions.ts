...
export class Functions {
     ...
     *
     */
    public static functionToScript(
        func: (...args: any[]) => void,
        ...args: any[]
    ): string {
     ...
     * @param callback
     */
    public static async forOwnKeys(
        dict: { [key: string]: any },
        callback: KeyValueCallback
    ) {
        Preconditions.assertNotNull(dict, 'dict');
    ...
    public static createSiblings(arrayLikeObject: any) {
        ...
        const result: Array<IArrayPosition<any>> = [];
...
export const ASYNC_NULL_FUNCTION = async () => {
    /* no op */
};
