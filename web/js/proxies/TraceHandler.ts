...
export class TraceHandler {
    ...
    constructor(
        ...
        this.traceIdentifier = Preconditions.assertNotNull(
            traceIdentifier,
            'traceIdentifier'
        );
    ...
    public set(target: any, property: string, value: any, receiver: any) {
        ...
        if (typeof value === 'object') {
            ...
            value = (<any>this.proxies).create(value, traceListeners, {
                pathPrefix,
            });
        }
