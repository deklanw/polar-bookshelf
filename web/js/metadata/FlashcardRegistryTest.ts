            ...
            const expected = [
                {
                    ...
                    fields: {
                        ...
                        extra: {
                            ...
                            type: 'TEXT',
                            description:
                                'Extra data shown after the card has been answered.',
                            rememberLastInput: false,
                            required: false,
                        },
                        source: {
                            ...
                            type: 'TEXT',
                            description:
                                'The source of this card. Name of the webpage, book, whitepaper, etc.',
                            rememberLastInput: false,
                            required: false,
                        },
                        link: {
                            ...
                            type: 'URL',
                            description:
                                'A link for more information regarding this flashcard. Usually the link to the source.',
                            rememberLastInput: false,
                            required: false,
                        },
                        image: {
                            ...
                            type: 'IMAGE_URL',
                            description:
                                'A link to an image for this flashcard.',
                            rememberLastInput: false,
                            required: false,
                        },
                    },
                },
                {
                    ...
                    description:
                        'Standard front and back flashcard (plus reverse)',
                    fields: {
                        front: {
                            name: 'front',
                            type: 'TEXT',
