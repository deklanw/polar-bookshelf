            ...
            <div className="p-3 m-2 rounded" style={Styles.notice}>
                <div className="pt-1 pb-1">
                    ...
                    <p>
                        ...
                        determine which features are used and how often and to
                        improve the quality of product over time.
                    </p>

                    <p>
                        Additionally, we track errors and send them along with
                        exception reports to fix errors that happen in
                        production. This helps us track down bugs that happen in
                        the wild and to prioritize which issues to fix based on
                    ...
                    <div style={Styles.intro}>Cloud storage and privacy.</div>
