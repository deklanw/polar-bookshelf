...
export class InviteUsersModal extends React.Component<IProps, IState> {
                ...
                <ModalBody>
                    <InviteUsersContent
                        onInvitedUserText={invitedUsersText =>
                            this.onInvitedUserText(invitedUsersText)
                        }
                    />
                </ModalBody>
                <ModalFooter>
                    ...
                    <Button color="primary" onClick={() => this.onInvite()}>
                        Invite
                    </Button>
                </ModalFooter>
            </Modal>
    ...
    private onInvite() {
        const emailAddresses = EmailAddressParser.parse(this.invitedUsersText);
