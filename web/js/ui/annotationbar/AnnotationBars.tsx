...
export class AnnotationBars {
    public static create(
        ...
        const annotationBarTriggerEventDispatcher = new SimpleReactor<
            AnnotationBarTriggerEvent
        >();
        ...
        const child = (
            <AnnotationBar
                popupStateEventDispatcher={
                    controlledPopupProps.popupStateEventDispatcher
                }
    ...
    private static registerEventListener(
        ...
        ActiveSelections.addEventListener(activeSelectionEvent => {
            ...
            annotationBarTriggerEventDispatcher.dispatchEvent(
                annotationBarTriggerEvent
            );
        }, target);
    }
