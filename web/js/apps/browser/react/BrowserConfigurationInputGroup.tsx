...
> {
        ...
        return (
            ...
            >
                <DropdownToggle caret>
                    <span className="fab fa-chrome fa-lg" aria-hidden="true" />
                </DropdownToggle>
                <DropdownMenu right>
                    ...
                    <DropdownItem
                        data-browser-name="MOBILE_GALAXY_S8"
                    ...
                    <DropdownItem
                        data-browser-name="MOBILE_GALAXY_S8_WITH_CHROME_66_WIDTH_700"
                        onClick={(event: React.MouseEvent<HTMLElement>) =>
                            this.onClick(event)
                        }
                    >
                    ...
                    <DropdownItem
                        data-browser-name="MOBILE_GALAXY_S8_WITH_CHROME_66_WIDTH_750"
                        onClick={(event: React.MouseEvent<HTMLElement>) =>
                            this.onClick(event)
                        }
                    >
                    ...
                    <DropdownItem
                        data-browser-name="DESKTOP_1024"
                        onClick={(event: React.MouseEvent<HTMLElement>) =>
                            this.onClick(event)
                        }
                    >
                    ...
                    <DropdownItem
                        data-browser-name="DESKTOP_1280"
                        onClick={(event: React.MouseEvent<HTMLElement>) =>
                            this.onClick(event)
                        }
                    >
                    ...
                    <DropdownItem
                        data-browser-name="DESKTOP_1920"
                        onClick={(event: React.MouseEvent<HTMLElement>) =>
                            this.onClick(event)
                        }
                    >
    ...
    private onClick(event: React.MouseEvent<HTMLElement>): void {
        ...
        Optional.of(this.props.onBrowserChanged).map(callback =>
