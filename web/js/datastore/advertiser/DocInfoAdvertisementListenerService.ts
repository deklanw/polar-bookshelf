...
import {
    DocInfoAdvertisement,
    DocInfoAdvertisementListener,
} from './DocInfoAdvertisement';
...
export class DocInfoAdvertisementListenerService {
    private readonly reactor: SimpleReactor<
        DocInfoAdvertisement
    > = new SimpleReactor();
    ...
    private onDocInfoAdvertisement(
        event: any,
        docInfoAdvertisement: DocInfoAdvertisement
    ) {
    ...
    public addEventListener(
        docInfoAdvertisementListener: DocInfoAdvertisementListener
    ): void {
