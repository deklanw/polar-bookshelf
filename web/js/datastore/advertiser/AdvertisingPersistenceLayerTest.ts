...
describe('AdvertisingPersistenceLayer', function() {
    it('addEventListenerForDoc', async function() {
        ...
        const defaultPersistenceLayer = new DefaultPersistenceLayer(
            new MemoryDatastore()
        );

        const advertisingPersistenceLayer = new MockAdvertisingPersistenceLayer(
        ...
        assertJSON(
            Dictionaries.sorted(advertised),
