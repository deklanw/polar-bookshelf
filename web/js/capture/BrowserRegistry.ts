...
const BrowserRegistry: { [name: string]: Browser } = {
    ...
    MOBILE_GALAXY_S8: new Browser({
        ...
        userAgent:
            'Mozilla/5.0 (Linux; Android 8.0.0; SM-G955U Build/R16NW) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.181 Mobile Safari/537.36',
        inactive: false,
    ...
    MOBILE_GALAXY_S8_WITH_CHROME_66_WIDTH_700: new Browser({
        ...
        type: 'phone',
        description:
            'Galaxy S8 mobile device running Chrome 66 but with width at 700',
        userAgent:
            'Mozilla/5.0 (Linux; Android 8.0.0; SM-G955U Build/R16NW) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.181 Mobile Safari/537.36',
        inactive: true,
    ...
    MOBILE_GALAXY_S8_WITH_CHROME_66_WIDTH_750: new Browser({
        ...
        type: 'phone',
        description:
            'Galaxy S8 mobile device running Chrome 66 but with width at 750',
        userAgent:
            'Mozilla/5.0 (Linux; Android 8.0.0; SM-G955U Build/R16NW) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.181 Mobile Safari/537.36',
        inactive: true,
...
BrowserRegistry.DEFAULT =
    BrowserRegistry.MOBILE_GALAXY_S8_WITH_CHROME_66_WIDTH_750;
