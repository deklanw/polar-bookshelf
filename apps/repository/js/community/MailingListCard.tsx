            ...
            <Card>
                ...
                <CardBody>
                    <div className="text-center">
                        <form
                            action="https://spinn3r.us10.list-manage.com/subscribe/post?u=0b1739813ebf118e92faf8fc3&amp;id=ad3d53e837"
                            method="post"
                        ...
                        >
                            <div
                                id="mc_embed_signup"
                                className="input-group mt-4 mb-4"
                            >
                                <input
                                    name="EMAIL"
                                    type="text"
                            ...
                            <p className="text-h5 text-muted">
                                <em>
                                    * Your email address is safe with us. We
