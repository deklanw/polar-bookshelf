...
export class Blackout {
    ...
    public static enable() {
        ...
        const style =
            'height:100%; width:100%; position:absolute; top:0; left:0; background-color:#000000; opacity: 0.3;';

        const blackoutElement = Elements.createWrapperElementHTML(
            `<div id="blackout" style="${style}">`
        ).firstChild!;
